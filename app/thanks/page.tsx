      ...
      <div className="max-w-2xl w-full">
        <div className="card-surface bg-white p-8 sm:p-12 lg:p-16 text-center">
          ...
          <p className="text-base text-ink/60 mb-8 leading-7">
            Tezroq javob olish uchun hoziroq operatorimizga yozing:
          </p>
          ...
          <div className="mb-8 space-y-3">
            ...
            {(isWhatsApp || (!isWhatsApp && !isTelegram)) && (
                ...
                className="flex items-center justify-center gap-3 rounded-2xl bg-[#25D366] px-6 py-4 font-bold text-white shadow-lg hover:scale-105 transition-transform"
              >
            ...
            {(isTelegram || (!isWhatsApp && !isTelegram)) && (
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 rounded-2xl bg-[#229ED9] px-6 py-4 font-bold text-white shadow-lg hover:scale-105 transition-transform"
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
